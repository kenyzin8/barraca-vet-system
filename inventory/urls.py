...
urlpatterns = [
    ...
    path('admin/inventory/product-type/update/<int:type_id>/', permission_required('inventory.add_product', raise_exception=True)(views.update_type_page), name='update-type-page'),
