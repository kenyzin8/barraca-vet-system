...
urlpatterns = [
    ...
    path('admin/pet-consultation/', permission_required('record_management.add_petmedicalrecord', raise_exception=True)(views.medical_record), name='admin-medical-record-page'),
    path('admin/submit-consultation/', permission_required('record_management.add_petmedicalrecord', raise_exception=True)(views.SubmitConsultationView.as_view()), name='admin-submit-consultation-page'),
    ...
    path('admin/upload-lab-image/', permission_required('record_management.add_petmedicalrecord', raise_exception=True)(views.LabResultImageUploadView.as_view()), name='admin-upload-lab-image-page'),
    path('admin/add-pet-medical-prescription/', permission_required('record_management.add_petmedicalprescription', raise_exception=True)(views.add_medical_prescription), name='admin-add-pet-medical-prescription-page'),
    path('admin/add-pet-medical-prescription/submit/', permission_required('record_management.add_petmedicalprescription', raise_exception=True)(views.SubmitPrescription.as_view()), name='admin-submit-pet-medical-prescription-page'),
    path('admin/add-pet-health-card-treatment/', permission_required('record_management.add_pethealthcard', raise_exception=True)(views.add_health_card_treatment), name='admin-add-pet-health-card-treatment-page'),
    path('admin/add-pet-health-card-treatment/submit/', permission_required('record_management.add_pethealthcard', raise_exception=True)(views.SubmitHealthCardTreatment.as_view()), name='admin-submit-pet-health-card-treatment-page'),
    ...
    path('admin/update-consultation/<int:treatmentID>/', permission_required('record_management.add_petmedicalrecord', raise_exception=True)(views.update_medical_record), name='admin-update-consultation-page'),
    path('admin/update-consultation/submit/', permission_required('record_management.add_petmedicalrecord', raise_exception=True)(views.UpdateConsultationView.as_view()), name='admin-submit-update-consultation-page'),
    path('admin/delete-consultation/<int:treatmentID>/', permission_required('record_management.add_petmedicalrecord', raise_exception=True)(views.delete_treatment), name='admin-delete-consultation-page'),
    path('admin/enable-consultation/<int:treatmentID>/', permission_required('record_management.add_petmedicalrecord', raise_exception=True)(views.enable_treatment), name='admin-enable-consultation-page'),
    path('admin/get-cycle-data/<int:petID>/', permission_required('record_management.add_pethealthcard', raise_exception=True)(views.get_treatment_cycle_status), name='get-treatment-cycle-data'),
